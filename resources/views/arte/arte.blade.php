<div class="accordion-item">
    <h2 class="accordion-header" id="arte">
        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseArte" aria-expanded="false" aria-controls="collapseArte">
            <figure>
            <blockquote class="blockquote"> <p> "Me gusta el arte; todo tipo de arte." </p> </blockquote>
            <figcaption class="blockquote-footer"> <cite title="Source Title">Juan Sanchez</cite> </figcaption>
            </figure>
        </button>
    </h2>
            ...
            <div class="list-group">
                <div class="list-group-item list-group-item-action" aria-current="true">
                    <div class="d-flex w-100 justify-content-between">
                        <h5 class="mb-1"> Obscur </h5>
                        <small>2021</small>
                    </div>
                    <p class="mb-2"> Lineas que deciden su sentido y su largo. </p>
                    <small class="mt-4"> pixels sobre dispositivo <br> </small>
                ...
                <div class="list-group-item list-group-item-action" aria-current="true">
                    <div class="d-flex w-100 justify-content-between">
                        <h5 class="mb-1"> Circulos en un Círculo </h5>
                        <small>2019</small>
                    </div>
                    <p class="mb-2"> Un humilde homenaje a W. Kandinsky. </p>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <p class="mb-1">
                            ...
                            <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#modalCodigoCirculos"> Código </button>
                        </p>
                    </div>
                </div>
                <div class="list-group-item list-group-item-action" aria-current="true">
                    <div class="d-flex w-100 justify-content-between">
                        <h5 class="mb-1"> Floralis </h5>
                        <small>2019</small>
                    </div>
                    <p class="mb-1"> Taraxacum officinale.  </p>
                    <small>O casi.</small>
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <p class="mb-1">
                    <a class="btn btn-outline-secondary" href="floralis" target="_blank" role="button">Artegrama</a>
                    <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#modalCodigoFloralis"> Código </button>
                    </p>
                    </div>
                </div>
            </div>
